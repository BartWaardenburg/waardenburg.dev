...
- **Blog:** Structure for later, not priority now

---

## Site Structure

**Single scrolling homepage** with anchor sections. Clean, personal, scannable.
...
- Experience leading teams (up to 40 developers at ANWB)
- You care about user experience, not just code
...
>
> Front-end is where I'm most at home. But I've learned that good software comes from understanding the full picture — the back-end, the content model, the people using it.
>
> When I'm not on client work, I'm building Leveret — a running app for trail and mountain athletes. Always happy to chat.
...
**Framing:** You've spoken at meetups with solid audiences. Don't emphasize dates, but the topics are still relevant and you're proud of the work.

**Talks:**

**React and the Three Layers of Testing**
React Amsterdam Meetup
How to ship quality code regularly: static analysis, type checking, and testing strategies.

**Building a Design System with (P)React**
React Amsterdam Meetup
Lessons from building ANWB's design system: sharing code across teams, consistency, and component architecture.

**Hybrid Apps**
Hippo Connect
Earlier talk on hybrid mobile development approaches.

**Links:** Slides available on Notist and SlideShare

---

### 6. Contact

**Message:** "Always open to chat"
...
**Optional addition:** A brief note like "Whether it's a project, a question, or just talking front-end — drop me a line."

---

## What You're Known For

Based on your work, here's what comes through:

1. **Flexible role** — Tech lead, full-stack, or front-end depending on what the project needs
2. **Front-end expert** — That's the core, with full-stack capability around it
3. **Leadership experience** — Led 40 front-end developers at ANWB
4. **Works across contexts** — Government, agencies, cultural institutions, product
5. **Communication & design background** — You understand the user side, not just the code
6. **Trusted with serious work** — Government identity systems, critical infrastructure
7. **Keeps building** — Leveret on the side shows you're always making things

**Suggested positioning:**
"Full-stack developer and front-end expert. Sometimes tech lead, sometimes hands-on — whatever the project needs."
...
- Detailed tech stack lists (keep it light)
- AWS mention (per your feedback)
- Open source / minvws mentions (not interesting per your feedback)
- Blog section (maybe later)
